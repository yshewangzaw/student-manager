...
export default function StudentModal({ student, onClose }) {
  const { grades, attendance, courses, calcLetterGrade, getAttendanceRate } =
    useAppContext();
    ...
    <div className="modal-backdrop scale-in" onClick={onClose}>
      <div className="modal-box" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-header">
          ...
          <div>
            <h2 className="modal-name">{student.full_name}</h2>
        ...
        <div className="modal-sections">
                    ...
                    {studentGrades.map((g) => {
                      ...
                      return (
                        <tr key={g.id}>
                          ...
                          <td>{g.semester}</td>
                          <td>
                            <strong>{g.score}</strong>/100
                          </td>
                          <td>
                            <span
                              className={`badge badge-${letter.replace("+", "plus").replace("-", "minus")}`}
                            >
                              {letter}
                            </span>
                          </td>
          ...
          <div className="modal-section">
            ...
            <div className="attendance-summary">
              <div className="att-pill att-present">
                ✅ Present: {statusCounts.present}
              </div>
              <div className="att-pill att-absent">
                ❌ Absent: {statusCounts.absent}
              </div>
              <div className="att-pill att-late">
