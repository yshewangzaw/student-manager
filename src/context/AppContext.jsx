...
// ─── seed data ─────────────────────────────────────────────────────────────
const SEED_COURSES = [
  { id: 1, code: "CS101", name: "Introduction to Computer Science", teacherId: 1, credits: 3, description: "Fundamentals of programming and computation", semester: "2024-S1" },
  { id: 2, code: "MATH201", name: "Calculus II", teacherId: 2, credits: 4, description: "Integrals, series and differential equations", semester: "2024-S1" },
  { id: 3, code: "ENG102", name: "English Composition", teacherId: 3, credits: 2, description: "Academic writing and communication", semester: "2024-S1" },
  { id: 4, code: "CS301", name: "Data Structures & Algorithms", teacherId: 1, credits: 4, description: "Core algorithms and data structures", semester: "2024-S2" },
];

const SEED_TEACHERS = [
  { id: 1, name: "Dr. Alan Smith",    subject: "Computer Science", email: "asmith@school.edu",   phone: "+1-555-0101", experience: 12, qualification: "PhD in CS" },
  { id: 2, name: "Prof. Maria Santos", subject: "Mathematics",      email: "msantos@school.edu",  phone: "+1-555-0102", experience: 8,  qualification: "MSc Mathematics" },
  { id: 3, name: "Mrs. Linda Johnson", subject: "English",           email: "ljohnson@school.edu", phone: "+1-555-0103", experience: 6,  qualification: "MA English Literature" },
];

const SEED_STUDENTS = [
  { id: 1, name: "Alice Chen",    age: 20, course: "CS",   batch: "2023", email: "alice@student.edu",  phone: "+1-555-1001", gender: "Female", status: "active",   enrollmentDate: "2023-09-01", gpa: 3.8 },
  { id: 2, name: "Bob Martinez",  age: 22, course: "Math", batch: "2022", email: "bob@student.edu",    phone: "+1-555-1002", gender: "Male",   status: "active",   enrollmentDate: "2022-09-01", gpa: 3.2 },
  { id: 3, name: "Carol White",   age: 21, course: "CS",   batch: "2023", email: "carol@student.edu",  phone: "+1-555-1003", gender: "Female", status: "active",   enrollmentDate: "2023-09-01", gpa: 3.5 },
  { id: 4, name: "David Brown",   age: 23, course: "Eng",  batch: "2021", email: "david@student.edu",  phone: "+1-555-1004", gender: "Male",   status: "graduated",enrollmentDate: "2021-09-01", gpa: 3.1 },
  { id: 5, name: "Eva Kim",       age: 20, course: "CS",   batch: "2024", email: "eva@student.edu",    phone: "+1-555-1005", gender: "Female", status: "active",   enrollmentDate: "2024-01-15", gpa: 3.9 },
  { id: 6, name: "Frank Lee",     age: 21, course: "Math", batch: "2023", email: "frank@student.edu",  phone: "+1-555-1006", gender: "Male",   status: "inactive", enrollmentDate: "2023-09-01", gpa: 2.7 },
];
...
export function AppProvider({ children }) {
  ...
  const [attendance, setAttendance] = useLocalStorage("sm_attendance", SEED_ATTENDANCE);
  ...
  function addGrade(data) {
    ...
    setTimeout(() => {
      ...
      if (newGpa !== null) {
        setStudents(prev => prev.map(s => s.id === data.studentId ? { ...s, gpa: newGpa } : s));
      }
      setLoading(false);
  ...
  function deleteGrade(id) {
    ...
    setTimeout(() => {
      ...
      if (grade) {
        ...
        setStudents(prev => prev.map(s => s.id === grade.studentId ? { ...s, gpa: newGpa ?? s.gpa } : s));
      }
      setLoading(false);
  ...
  const stats = {
    ...
    avgGpa: students.length
      ? Math.round((students.reduce((sum, s) => sum + (s.gpa || 0), 0) / students.length) * 100) / 100
      : 0,
  ...
  return (
    <AppContext.Provider
      value={{
        ...
        // students
        students, editingStudent, setEditingStudent,
        addStudent, updateStudent, deleteStudent,
        // teachers
        teachers, editingTeacher, setEditingTeacher,
        addTeacher, updateTeacher, deleteTeacher,
        // courses
        courses, editingCourse, setEditingCourse,
        addCourse, updateCourse, deleteCourse,
        // grades
        grades, addGrade, updateGrade, deleteGrade,
        // attendance
        attendance, saveAttendance, getAttendanceRate,
        // helpers
        calcLetterGrade,
        // stats
        stats,
